  ...
  <div class="w-full h-full">
    ...
    <div class="ml-12 mt-12 flex items-center">
      ...
      <div
        ...
        v-if="
          isActive === 0 || isActive === 1 || isActive === 2 || isActive === 3
        "
      >
        <div>
          <el-input
            size="mini"
            v-model="value1StartTime"
            placeholder="开始时间"
            clearable
          >
          </el-input>
