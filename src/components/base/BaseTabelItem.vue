      ...
      <el-table-column width="360">
        <template #header>
          <div>
            ...
            <app-svg-icon
              class="hover:cursor-pointer hover:bg-gray-300 rounded w-18 h-18"
              iconName="icon-all-row"
        ...
        <template #default="scope">
          ...
          <app-svg-icon
            v-show="scope.row.children && scope.row.children.length"
            class="
