...
export const BASE_URL_REPOSTORY: string = import.meta.env.VITE_BASE_URL_REPOSTY as string

// console.log(config, "config");
export const BASE_URL_REPOSTORYTwo: string = import.meta.env.VITE_BASE_URL_REPOSTY_TWO as string
// 全局变量 config
// export const BASE_URL_REPOSTORYTwo: string = config.url;
...
export const MAX_PAGE_SIZE: number = 2 ** 31 - 1 // 分页获取数据接口传这个值获取所有数据
...
// 所有语言
export const LANGUAGES: App.Language[] = [
  {
    lang: 'zh-CN',
    name: '简体中文',
  },
